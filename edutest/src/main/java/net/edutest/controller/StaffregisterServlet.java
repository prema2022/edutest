...
public class StaffregisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/quiz_db?useSSL=false", "root", "root");

            // Prepare the SQL statement
            String sql = "INSERT INTO staffregisterdb (user_name, passkey, passkey1) VALUES (?, ?, ?)";
