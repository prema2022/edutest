...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/quiz_db?useSSL=false", "root", "root");
            java.sql.PreparedStatement pst = con.prepareStatement("select * from staffregisterdb where user_name = ? and passkey = ?");
            ...
            if(rs.next()) {
                ...
                dispatcher = request.getRequestDispatcher("WEB-INF/views/question.jsp");
            } else {
